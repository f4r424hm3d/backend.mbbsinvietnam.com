              ...
              <form action="{{ $url }}/" class="needs-validation" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 mb-3">
                    <x-TextareaField label="Content" name="tab_content" id="tab_content" :ft="$ft"
              ...
              <table id="datatable" class="table table-bordered dt-responsiv nowra w-100">
                ...
                <tbody>
                  ...
                  @foreach ($rows as $row)
                    <tr id="row{{ $row->id }}">
                      <td>{{ $i }}</td>
                      <td><input onchange="updatePriority('<?php echo $row->id; ?>',this.value)" style="width:60px!important;"
                          type="number" value="<?php echo $row->priority; ?>" min="0"></td>
